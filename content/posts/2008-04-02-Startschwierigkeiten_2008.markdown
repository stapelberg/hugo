...
<h1>Der 945-GT-Chipsatz und Speicher</h1>
...
CPU: Intel Genuine Intel(R) CPU           T2400  @ 1.83GHz stepping 08
...
Pid: 1, comm: swapper Not tainted 2.6.24.3 #7
 [&lt;c017c72a&gt;] sysfs_add_one+0x54/0xb7
 [&lt;c017d289&gt;] sysfs_create_link+0x9a/0xe5
 [&lt;c017c256&gt;] sysfs_add_file+0x47/0x65
 [&lt;c022b52e&gt;] pci_bus_add_devices+0xba/0xff
 [&lt;c0370379&gt;] pcibios_scan_root+0x25/0x80
 [&lt;c0118fac&gt;] printk+0x1b/0x1f
 [&lt;c0595357&gt;] pci_legacy_init+0x53/0xe1
 [&lt;c057860e&gt;] kernel_init+0xb9/0x21b
 [&lt;c0103aa6&gt;] ret_from_fork+0x6/0x1c
 [&lt;c0578555&gt;] kernel_init+0x0/0x21b
 [&lt;c0578555&gt;] kernel_init+0x0/0x21b
 [&lt;c0103e5b&gt;] kernel_thread_helper+0x7/0x10
 =======================
...
Pid: 1, comm: swapper Not tainted 2.6.24.3 #7
 ...
 [&lt;c0103e5b&gt;] kernel_thread_helper+0x7/0x10
 =======================
pci 0000:00:1c.0: Error creating sysfs bridge symlink, continuing...
sysfs: duplicate filename 'bridge' can not be created
WARNING: at fs/sysfs/dir.c:424 sysfs_add_one()
Pid: 1, comm: swapper Not tainted 2.6.24.3 #7
 [&lt;c017c72a&gt;] sysfs_add_one+0x54/0xb7
 ...
 [&lt;c0103e5b&gt;] kernel_thread_helper+0x7/0x10
 =======================
pci 0000:00:1c.4: Error creating sysfs bridge symlink, continuing...
sysfs: duplicate filename 'bridge' can not be created
WARNING: at fs/sysfs/dir.c:424 sysfs_add_one()
Pid: 1, comm: swapper Not tainted 2.6.24.3 #7
 [&lt;c017c72a&gt;] sysfs_add_one+0x54/0xb7
 ...
 [&lt;c0103e5b&gt;] kernel_thread_helper+0x7/0x10
 =======================
pci 0000:00:1c.5: Error creating sysfs bridge symlink, continuing...
sysfs: duplicate filename 'bridge' can not be created
WARNING: at fs/sysfs/dir.c:424 sysfs_add_one()
Pid: 1, comm: swapper Not tainted 2.6.24.3 #7
 [&lt;c017c72a&gt;] sysfs_add_one+0x54/0xb7
...
Sending DHCP requests .&lt;6&gt;0000:03:00.0: eth0: Link is Up 1000 Mbps Full Duplex, Flow Control: RX/TX
